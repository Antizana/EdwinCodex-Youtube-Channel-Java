...
class Ch14FindSecondLargestNumberTest {

	@Test
	@DisplayName("Find Second Largest {7, 5, 6, 1, 4, 2}")
	void testFindSecondLargest76() {
		int[] array = {7, 5, 6, 1, 4, 2};
		assertEquals(6, Ch14FindSecondLargestNumber.findSecondLargest(array));
	}
	...
	void testFindSecondLargest87() {
		...
		assertEquals(7, Ch14FindSecondLargestNumber.findSecondLargest(array));
	}
	...
	void testFindSecondLargestEmpty() {
		int[] array = {};
		assertEquals(0, Ch14FindSecondLargestNumber.findSecondLargest(array));
	}
	...
	void testFindSecondLargestEquals() {
		int[] array = {4, 4};
		assertEquals(4, Ch14FindSecondLargestNumber.findSecondLargest(array));
	}
